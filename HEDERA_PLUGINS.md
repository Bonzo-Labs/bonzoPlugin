...
const hederaAgentToolkit = new HederaLangchainToolkit({
  ...
  configuration: {
    ...
    plugins: [coreAccountPlugin, coreAccountQueryPlugin, coreConsensusPlugin, coreConsensusQueryPlugin, coreTokenPlugin, coreTokenQueryPlugin, coreEVMPlugin, coreEVMQueryPlugin],
  },
});
```
